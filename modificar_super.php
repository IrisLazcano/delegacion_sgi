                                            ...
                                            <fieldset class="fieldset1">
                                                ...
                                                <fieldset class="fieldset1">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <p>Folio</p>
                                                            <p><input disabled="disabled" name="referencia" class="form-control" type="text" onKeyPress="return letra(event)" onKeyUp="activar1()" value="<?php echo $row['folio']; ?>" required="required" onpaste="return false" tabindex="5" />
                                                        </div>
