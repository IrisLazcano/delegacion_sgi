...
<div class="container">
        <header class="row">
            ...
            <!-- Lado derecho -->
             ...
             <td width="350" align="right"><a href="tabla_admon.php" class="btn btn-info"> Regresar </a></td>
            ...
            <div class="center" style="text-align: center;"> 
                     <h3>
                             ...
                             AGREGAR NUEVO ASUNTO
                                ...
                                $query = "SELECT (max(folio) +1) from tbl_docs";
                                $resultado = $conexion->query($query);
                                 $row = $resultado->fetch(PDO::FETCH_COLUMN);
                                $idfolio = $row;
                                ?>

                                <form action="guardar1.php" method="post" class="form-control" enctype="multipart/form-data">
                                        ...
                                        <fieldset class="fieldset1">
                                            ...
                                            <fieldset class="fieldset1">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        Referencia
                                                        <input name="referencia" class="form-control" type="text" value="" required="required" tabindex="4" />
                                                    </div>
                                                    <div class="col-sm-4">
                                                        Folio
                                                        <input name="folio" class="form-control folio" type="text" disabled value="<?php echo $idfolio; ?>" required="required" tabindex="4" />
                                                    </div>
                                                </div>
                                                <p>Descripción</p>
