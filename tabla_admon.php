        ...
        <p>
            ...
            <div style="margin-left: 10px;" class="col-sm-1.5"> <!-- Inicio Menú -->
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                         ...
                         <a class="dropdown-item" href="./tabla_admon4.php?year=2022"> 2022</a>
                         <a class="dropdown-item" href="./tabla_admon3.php?year=2021"> 2021 </a>
                         <a class="dropdown-item" href="./tabla_admon1.php?year=2020"> 2020 </a>
                         <a class="dropdown-item" href="./tabla_admon2.php?year=2019"> 2019 </a>
