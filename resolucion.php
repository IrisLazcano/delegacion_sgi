        ...
        <p>
 			<section class="contenedor-main row">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                         ...
                         <a class="dropdown-item" href="./tabla_prin.php">PÁGINA PRINCIPAL</a>
            ...
            <div class="center" style="text-align: center;"> 
                     <h4>
                             ...
                             RESOLUCIÓN
                                ...
                                ?>
                                <form action="guardar_resolucion.php" method="post" class="form-control" enctype="multipart/form-data">
