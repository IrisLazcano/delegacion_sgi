                                        ...
                                        <form action="guardar_modificar.php" method="post" class="form-control" enctype="multipart/form-data">
                                            ...
                                            <fieldset class="fieldset1">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        Remitente
                                                        <p><input name="remitente" class="form-control" type="text" onKeyPress="return letra(event)" onKeyUp="activar1()" value="<?php echo $row['remitente']; ?>" required="required" onpaste="return false" tabindex="2" />
                                                    </div>
                                                </div>
                                                ...
                                                <fieldset class="fieldset1">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            ...
                                                            <p><input name="fechadoc" id="fechaid1" type="date" value="<?php echo $fecha = $row['fecha_doc']; ?>" required="required" class="form-control" tabindex="3" />
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <p>Referencia</p>
                                                            <p><input name="referencia" class="form-control" type="text" onKeyPress="return letra(event)" onKeyUp="activar1()" value="<?php echo $row['docreferencia']; ?>" required="required" onpaste="return false" tabindex="4" />
                                                        </div>

                                                        <div class="col-sm-4">
                                                            <p>Folio</p>
                                                            <p><input name="folio" class="form-control" type="text" onKeyPress="return letra(event)" onKeyUp="activar1()" value="<?php echo $row['folio']; ?>" required="required" onpaste="return false" tabindex="5" />                                                       </div>

                                                    </div>
                                                    <p>Descripción</p>
                                                    <p><textarea  name="asunto" type="text" class="form-control" onKeyUp="activar1()" required tabindex="6"><?php echo $row['descripcion']; ?> </textarea>

                                                        <p>Observaciones</p>
                                                        <p><input name="observacion" class="form-control" type="text" onKeyPress="return letra(event)" onKeyUp="activar1()" value="<?php echo $row['observacion']; ?>" onpaste="return false" tabindex="7">
