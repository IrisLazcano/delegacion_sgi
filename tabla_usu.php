        ...
        <p>
 			<section class="contenedor-main row">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                         ...
                         <a class="dropdown-item" href="./tabla_usu.php">PÁGINA PRINCIPAL</a>
            ...
            <div style="margin-left: 10px;" class="col-sm-1.5"> <!-- Inicio Menú -->
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                         ...
                         <a class="dropdown-item" href="./tabla_usu4.php?year=2022"> 2022</a>
                         <a class="dropdown-item" href="./tabla_usu3.php?year=2021"> 2021 </a>
                         <a class="dropdown-item" href="./tabla_usu1.php?year=2020"> 2020 </a>
                         <a class="dropdown-item" href="./tabla_usu2.php?year=2019"> 2019 </a>
            ...
            <div class="col-sm-2">
			 <table class="table">
                    ...
                    <td width="350" align="right"><a href="form_nuevo.php" class="btn btn-info"> Nuevo Registro </a></td>
                                ...
                                <div class="table-responsive-xl">
                                    <table class="table table-striped table-bordered table-hover dataTables-example">
                                        ...
                                        <tr>
                                            ...
                                            <th class="center"> Fecha de Documento </th>
                                        ...
                                        <tbody>
                                            ...
                                            $condicion = $year!='' ? "WHERE fechaact BETWEEN '$year-01-01' AND '$year-12-31'" : "";
                                            
                                               
                                            
                                            
                                            $sql="SELECT * FROM tbl_docs WHERE fechaact > '2023-01-01' ORDER BY folio DESC";
